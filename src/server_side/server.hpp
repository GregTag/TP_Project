...
class Server : public std::enable_shared_from_this<Server> {
   public:
    ...
    void registerClient(std::shared_ptr<ServersideClientHandler> handler);
   ...
   private:
    ...
    std::list<std::shared_ptr<ServersideClientHandler>> clients;
    std::unordered_map<size_t, std::weak_ptr<ServersideClientHandler>> client_by_id;
